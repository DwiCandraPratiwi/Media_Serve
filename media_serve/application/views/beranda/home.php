    ...
    <li><img class="image" border="0" src="assets/foto1.jpeg"  width="42px" style="margin: 1px;padding: 0px color:white;">-----</li>
    </ul></b>
...
<div class="container-fluid">
        ...
        <div class="carousel-inner">
            ...
            <img src="<?php echo base_url('assets/covid2.jpg')?>" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            <img src="<?php echo base_url('assets/covid1.jpg')?>" class="d-block w-100" alt="...">
        </div>
 ...
 <div class="card ml-3" style="width: 16rem;">
  <img src="<?php echo base_url().'/assets/'.$srg->gambar?>" class="card-img-top" alt="...">
  <div class="card-body">
